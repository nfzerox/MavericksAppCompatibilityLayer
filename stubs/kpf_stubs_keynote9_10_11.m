// kpf_stubs_keynote9_10_11.m -- the 10.13 -> 10.11 hand-stub surface for
// Keynote 9. This file is the 10.11-specific complement of
...
// NSSpellChecker text-substitution class properties (10.12+). 10.11 has
// no automatic capitalization / period substitution / text completion.
@interface NSSpellChecker (KPF1011)
@end
@implementation NSSpellChecker (KPF1011)
...
@property (nonatomic, strong) NSMutableArray<NSGridRow *> *kpf_rows;
@property (nonatomic, strong) NSMutableArray<NSGridColumn *> *kpf_columns;
...
- (instancetype)initWithCoder:(NSCoder *)coder {
    ...
    [NSLayoutConstraint activateConstraints:@[
        ...
        [vstack.trailingAnchor constraintLessThanOrEqualToAnchor:self.trailingAnchor],
        [vstack.bottomAnchor   constraintLessThanOrEqualToAnchor:self.bottomAnchor],
    ]];
    for (NSGridRow *row in _kpf_rows) {
