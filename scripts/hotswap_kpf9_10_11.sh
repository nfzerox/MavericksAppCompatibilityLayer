#!/bin/bash
# hotswap_kpf9_10_11.sh [user@host]
#
# Fast-iterate on the 10.11 Keynote 9 bundle. Pushes the latest
# kpf_stubs_keynote9_10_11.m and rebuilds kpf_stubs.dylib on the guest, drops
# it into the bundle's Frameworks/ and into every nested XPCService's
# Frameworks/. Does NOT re-sign.
#
# Run scripts/setup_keynote9_10_11.sh once before this for the patcher
